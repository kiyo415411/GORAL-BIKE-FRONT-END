...
function CourseAside({ contextValue }) {
  ...
  return (
    <div className="sticky-top mt-5" style={{ width: '22rem' }}>
      <div className="course-list-aside p-4">
        {/* ----------------------------- 關鍵字篩選 */}
        ...
        <div className="d-flex gap-1 mb-5 px-2">
          ...
          <div className="position-relative w-auto h-auto">
            ...
            <input
              ...
              min={Data.startDateSubmit ? Data.startDateSubmit : Data.startDate}
              max={Data.endDate}
