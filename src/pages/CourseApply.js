...
export default function CourseApply() {
  ...
  return (
    <div
      className="shadow text-content py-5 my-5 mx-auto"
      style={{ width: '43rem' }}
    >
      {/* ----------------------- 表頭 */}
      ...
      >
        ...
        <div className="col-12 d-flex justify-content-end mt-3 pe-5">
          ...
          <button
            className="text-nowrap m-0 btn fs-6 border-2 px-4 py-1 me-5 rounded-0 btn-outline-primary rounded-pill"
            type="submit"
          >
            送出
          </button>
